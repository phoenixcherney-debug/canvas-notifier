...
1. Scroll to “Approved Integrations” → click “+ New Access Token”
1. Give it a name like “Grade Notifier” and copy the token

How to get your ntfy topic:

1. Install the free “ntfy” app on your iPhone from the App Store
1. Tap + and subscribe to a unique topic name e.g. “phoenix123-canvas-8472”
   “””
...
params = {“type[]”: “StudentEnrollment”, “state[]”: “active”, “user_id”: “self”}
response = requests.get(url, headers=get_headers(), params=params)
